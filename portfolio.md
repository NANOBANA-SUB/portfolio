...
## ClipStudioPaintのライブラリ・フレームワーク開発
- **勤務期間:2025年4月〜2025年7月**
- **使用技術:C++, boost, git**
- **ポジション:ソフトウェアエンジニア**
- **経験した業務:新規ライブラリの要件定義、詳細設計、実装**

### **概要**
株式会社セルシスにて同社製品のClipStudioPaintの開発に携わる長期インターンを行なっておりました。
同インターンでは実際の製品に組み込むライブラリの設計と実装を行い、新機能を製品に実装しました。

この経験を通じて大規模開発の基礎と、新規フレームワーク・ライブラリを俯瞰して理解する知見を習得しました。

### **開発内容と貢献**
全世界4300万人が利用するイラストアプリケーション、ClipStudioPaintにおけるライブラリ・フレームワークの開発を行なっておりました。
私は主にUI/UX関係のライブラリ開発を行っており、他の開発メンバーと議論しながら製品に必要なライブラリを一部製作しました。
ライブラリの実装ではFlutterやReactをはじめとしたフロントエンド系のフレームワークを参考にすることで、モダンなUIかつ直感的な使い方ができるようなクラスを書くようにしてきました。

### **成果と学び**
インターンを通じて、大規模ソフトウェア開発の基礎や、ライブラリ・フレームワークを俯瞰して理解する力を養うことができました。
私はこれまで小規模な開発しか経験がなく、大規模な開発がどのように進められているのかについて十分な理解がありませんでした。
しかし今回の経験を通じて、大規模開発では課題を細分化し、メンテナンス性を高めつつ、バグの少ない堅牢な実装を目指す進め方が取られていることを学びました。

また、社内独自のライブラリ開発に携わる中で、ライブラリ全体を俯瞰しながら設計意図や構造を把握する力が身につきました。
自分が担当する箇所の仕様や意図を正確に理解するために、基底クラスを確認したり、類似の実装を探したりといったアプローチを繰り返す中で、ライブラリ全体の設計コンセプトを意識して読み解く姿勢が自然と身につきました。
...
開発チームは4人体制で進めており、リードエンジニアとして要件整理、設計、実装を主導。
